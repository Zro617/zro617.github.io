var regex = {
	...
	notAE:/only|quality|simple|good|awesome|fantastic|great|amazing|test|science|math|programming|computer|tech|info|advice/gi,
	extras:null,
	set:function(r){if(r)this.extras=new RegExp(r,"gi");},
