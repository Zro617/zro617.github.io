...
ac(qs("header"),header);ac(qs("footer"),footer);ac(qs("head"),e("link",{rel:"shortcut icon",href:"https://cloud.githubusercontent.com/assets/11638093/12807329/2f8206e4-cad4-11e5-9881-a2ff91b2fb8e.png",type:"image/x-icon",sizes:"32x32"},""));
})([{name:"Home",link:"//zro617.github.io"},{name:"About Me",link:"//zro617.github.io/aboutme.html"}],[{name:"Copyright &copy; 2015-2016 Zro617",link:""},{name:"GitHub",link:"//github.com/Zro617"},{name:"Scratch",link:"//scratch.mit.edu/users/Zro716"},{name:"SoundCloud",link:"//soundcloud.com/zro-from-scratch"},{name:"Google+",link:"//plus.google.com/103893775840439999959"},{name:"Email",link:"mailto:zropotato@gmail.com"}]);
